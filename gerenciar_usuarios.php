...
<body>
    ...
    <div class="menu-list">
        ...
        <div class="content">
            ...
            <!-- Adicione conteúdo específico da administração aqui -->
        </div>

        <div class="user-container">
            <?php
            try {
                $stmt = $pdo->prepare("SELECT id_usuario, nome_usuario FROM usuarios");
                $stmt->execute();
                ...
                if (count($result) > 0) {
                    foreach ($result as $row) {
                        echo "<div class='user-card'>
                                <div>" . htmlspecialchars($row["nome_usuario"]) . "</div>
                                <form action='usuario_detalhes.php' method='get'>
